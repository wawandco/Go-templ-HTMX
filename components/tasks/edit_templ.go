...
func Edit(tsk models.Task) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"w-full p-5 flex items-center justify-between\"><div class=\"flex gap-3 text items-center\"><div><input type=\"checkbox\"></div><div class=\"text-gray-500 font-semibord text-base\"><input type=\"text\" name=\"title\" value=\"")
