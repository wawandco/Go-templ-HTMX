...
func Line(id string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"><td class=\"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900\"><button @click=\"count--\" hx-delete=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = Input(templ.Attributes{
			...
			"hx-post":   fmt.Sprintf("/set-total-line?line=%s", id),
			"hx-target": fmt.Sprintf("#total_line_%s", id),
			"hx-swap":   "innerHTML", "hx-trigger": "keyup changed delay:200ms",
		...
		templ_7745c5c3_Err = TotalLine("$0.00").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
